...
public class GreetingsListener {
    ...
    public void handleGreetings(@Payload Currency greetings, @Headers Map<String, Object> headers) {
        System.out.println("Received greetings: {}. Partition: {}. Offset: {}"+ greetings+
